...
-- 				vim.schedule(function() vim.notify("Gradle: Cached " .. #M.tasks .. " tasks!", vim.log.levels.INFO) end)
-- 			end
-- 		end,
-- 		on_stderr = on_stderr,
-- 	}):start()
...
-- 		on_exit = function(j, return_val)
-- 			if return_val == 0 then
-- 				vim.schedule(function() vim.notify("Gradle daemon started", vim.log.levels.INFO) end)
...
-- 				vim.schedule(function() vim.notify("Starting Gradle daemon...", vim.log.levels.INFO) end)
...
-- 						vim.notify("Detected changes in " .. vim.fn.fnamemodify(file, ":t") .. ", refreshing cache...", vim.log.levels.INFO)
-- 						M.refresh_cache()
-- 					end
-- 				end)
-- 			)
...
-- M.init = function() async_prepare_gradle_daemon() end
--
-- -- Setup function
...
-- 		vim.defer_fn(function() setup_file_watchers() end, 2000)
-- 	end
-- end
--
-- return M
