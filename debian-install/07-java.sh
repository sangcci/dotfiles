...
echo ""
echo "✓ SDKMan (Java/JDK Manager) installed successfully!"
echo "  SDKMan directory: $HOME/.sdkman"
echo ""
...
echo ""
echo "SDKMan automatically manages Java PATH when you install JDK versions"
echo ""
